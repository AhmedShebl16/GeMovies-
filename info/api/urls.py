...
from .views import (MainInfoAPIView, FAQsAPIView, AboutUsAPIView, TermsOfServiceAPIView, CookiePolicyAPIView,
                    PrivacyPolicyAPIView, ContactUsAPIView, HeaderImageAPIView, TeamMemberAPIView, NewsAPIView,
                    AwardAPIView, PartnerAPIView)
...
urlpatterns = [
    ...
    path('award/', AwardAPIView.as_view(), name='awards'),
    path('partner/', PartnerAPIView.as_view(), name='partners'),
]
