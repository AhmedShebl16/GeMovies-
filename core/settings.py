"""
Django settings for GeMovies project.
...
SECRET_KEY = 'django-insecure-i&&_ll)rgcr7q+7ayqy)(-wdjmm!qz-i5nj*wd-w&9-0ncaknm'
...
INSTALLED_APPS = [
    ...
    'info',
    'stats',
    'nancy.apps.NancyConfig',  # Ensure only this entry for nancy
]
MIDDLEWARE = [
...
BUILD_BASE_FILENAME = 'index.html'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates', BUILD_DIR],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#: Defines settings for the Simple JWT library, which is used for JSON Web Token authentication. This includes token
#: lifetime, signing key, and algorithm specifications.
SIMPLE_JWT = {
...
#: Contains configuration for Djoser, a library that provides a set of Django Rest Framework views to handle basic
#: actions such as registration, login, logout, password reset, and account activation.
DJOSER = {
    'PERMISSIONS': {
    ...
    'LOGIN_FIELD': 'email',
    "USER_ID_FIELD": 'id',
    'PASSWORD_RESET_CONFIRM_URL': 'api/auth/users/password_reset/{uid}/{token}',
    'USERNAME_RESET_CONFIRM_URL': 'api/auth/users/username_reset/{uid}/{token}',
...
SPECTACULAR_SETTINGS = {
    ...
    'SWAGGER_UI_FAVICON_HREF': '/static/images/logo-circle.png',
    ...
    'POSTPROCESSING_HOOKS': [
        ...
        'stats.hocks.postprocessing_exclude_stats_path'
    ],
    ...
    'TITLE': 'GeMovies',
    'DESCRIPTION': 'GeMovies API Endpoints',
    'TOS': None,
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "GeMovies Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "GeMovies",
    ...
    "site_icon": "images/logo-circle.png",

    # Welcome text on the login screen
    "welcome_sign": "Welcome To GeMovies",
